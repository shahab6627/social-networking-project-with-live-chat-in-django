    ...
    $.ajax({
        ...
        success : function(res){
            ...
            if(res.msg == "exists"){
                ...
                $('.user-created').html(`<span> account created successfully! a verification mail is send to  ${email} 
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                if(res.msg == 'true'){
                    ...
                    $('.account-error').html(`<span class="text-danger"> Email or password is incorrect </span>`)
                }
            }
        })
    }
